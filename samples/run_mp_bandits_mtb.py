...
def main(args):
    ...
    if args.play:
        ...
        while True:
            ...
            # TJ added - log actions
            action_log = np.append(action_log, np.reshape(actions,(1,4)), axis=0)
    ...
    np.savetxt('merge_data/mp_bandits_tb_cum_flowtime.txt', cum_flowtime) # better 
    np.savetxt('merge_data/mp_bandits_tb_actions.txt', action_log, fmt="%d")
    # np.savetxt('merge_data/mp_bandits_tb_actions.txt', action_log, fmt="%d")
    # np.savetxt('merge_data/mp_bandits_tb_actions.txt', action_log, fmt="%d")
